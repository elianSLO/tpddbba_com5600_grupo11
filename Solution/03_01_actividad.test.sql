...
DBCC CHECKIDENT ('Club.Actividad', RESEED, 0); -- Usar solo para delete luego de insertar

-- 8.1 INSERCIÓN DE ACTIVIDADES

-- 8.1.1 INSERCIÓN VÁLIDA
EXEC Club.insertarActividad
    @nombre = 'Futsal',
...
EXEC Club.eliminarActividad @nombre = 'Futsal';

-- Verificación de eliminación
SELECT * FROM Club.Actividad WHERE nombre = 'Futsal';

-- 8.3.2 Eliminación Fallida (Actividad no existente)

EXEC Club.eliminarActividad @nombre = 'Handball'; 